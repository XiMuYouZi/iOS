...
-(void) initData
{
    ...
    textImageItem.userNick = @"Allensdsd";
    textImageItem.title = @"";
    ...
    commentItem1_1.userNick = @"习大大sdsd";
    ...
    commentItem1_2.userNick = @"奥巴马sdds";
    commentItem1_2.text = @"欢迎来到美利坚";
    commentItem1_2.replyUserId = 10086;
    commentItem1_2.replyUserNick = @"习大大dsd";
